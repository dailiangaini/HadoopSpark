...
public enum KpiType {
    /**
     * 指标名称
     * new_install_user： 统计新用户的kpi
     * browser_new_install_user： 统计浏览器维度的新用户kpi
     * active_user： 统计活跃用户kpi
     * browser_active_member： 统计浏览器维度的活跃会员kpi
     * new_member： 统计新增会员kpi
     * insert_member_info： 插入会员信息kpi
     * sessions： 统计会话kpi
     * browser_sessions： 统计浏览器维度会话kpi
     * hourly_active_user： 按小时统计活跃用户kpi
     * hourly_sessions： 按小时统计会话格式kpi
     * hourly_sessions： 按小时统计会话格式kpi
     * hourly_sessions_length： 按小时统计会话长度kpi
     * website_pageview： 统计浏览器维度的pv kpi
     * location： 统计地域信息维度的kpi
     * inbound： 统计inbound维度信息的kpi
     * inbound_bounce： 统计inbound维度下的跳出会话kpi
     */
